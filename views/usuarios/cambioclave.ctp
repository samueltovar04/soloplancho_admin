 <?php     
        echo $this->Form->create('Usuario',array(
     		   ...
     		   echo $this->Form->input('Usuario.clave_actual',array('type'=>'password','label' =>'Clave Actual','div'=>array('class'=>'col-xs-8 form-group'),'class'=>"form-control", 'placeholder'=>"Clave Actual"));
     		
                    echo $this->Form->input('Usuario.clave_nueva',array('type'=>'password','label' =>'Nueva Clave','div'=>array('class'=>'col-xs-8 form-group'),'class'=>"form-control", 'placeholder'=>"Nueva Clave"));
     	            echo $this->Form->input('Usuario.confirma',array('type'=>'password','label' =>'Confirma Clave','div'=>array('class'=>'col-xs-8 form-group'),'class'=>"form-control", 'placeholder'=>"Confirma La Clave"));
