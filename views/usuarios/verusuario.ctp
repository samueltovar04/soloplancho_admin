...
?>    </div>
        ...
        <ul class="nav nav-tabs" role="tablist">
          ...
          <li role="presentation"><a href="#ordensem" aria-controls="ordensem" role="tab" data-toggle="tab">Ordenes de la Semana</a></li>
 ...
 |
		<?php echo $this->Paginator->next(__('siguiente', true) . ' >>', array(), null, array('class' => 'disabled'));?>
            ...
            <form method="post" action=""></form>
                        ...
                        <div role="tabpanel" class="tab-pane" id="ordensem">
                  
           <div  class="panel panel-default">
                <span class="title-window-panel"> 
                  <i class="fa fa-tags"></i> Ordenes de la Semana
                </span>
             <div class="panel-body">
              <?php
 if(isset($Exito)){echo $cargar->msj_exito($Exito);}
