<?php
    ...
    if(isset($Error)){echo $cargar->msj_error($Error);}
            ...
            <?php
                ...
                echo $this->Ajax->submit(__('Asignar Delivery', true), array('class'=>'btn btn-primary','div'=>array('class'=>'col-xs-3 form-group'),'url'=> array('controller'=>'Ordenes', 'action'=>'asigna_orden',$id), 'update' => 'asignar','loading'=>'mini_loading','indicator'=>'mini_loading'));
