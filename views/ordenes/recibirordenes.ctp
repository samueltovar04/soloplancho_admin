...
?>
                   ...
                   ?><div class="col-xs-12">
                    ...
                    <?php
                        echo $this->Form->input('OrdenServicio.peso_libras',array('readonly'=>false,'size'=>'6','label' =>false,'div'=>false,'class'=>"form-control",'id'=>'peso','maxlength'=>'5','onKeyPress'=>'return numeros_punto(event)'));
                 ?>
