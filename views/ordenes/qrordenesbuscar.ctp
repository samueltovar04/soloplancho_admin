<?php
  $paginator->options(array('url'=>array( 'controller' => 'Ordenes', 'action' => 'qrordenesbuscar',$ced),'update' => 'buscarord .panel-body', 'indicator' => 'mini_loading','loading'=>'mini_loading'));
...
<div  style="border:1px">
	...
	</tr></thead><tbody id='tblordenresul'>
	<?php
	$i = 0;
...
//<![CDATA[ 
  $('#tblordenresul tr').on('click', function(){ 
    var row=$(this).parent();
    var orden = $("#tblordenresul").children().eq($(this).index());  
