<?php
    ...
    if(isset($Error)){echo $cargar->msj_error($Error);}
              ...
              ?>
            <div class='col-xs-3'>
                <label class='form-group'>Ikaro De Envio Al Cliente</label>
            </div>
            <?php
                ...
                echo $this->Ajax->submit(__('Asignar Ikaro', true), array('class'=>'btn btn-primary','div'=>array('class'=>'col-xs-3 form-group'),'url'=> array('controller'=>'Ordenes', 'action'=>'asignaentrega',$id), 'update' => 'asignar','loading'=>'mini_loading','indicator'=>'mini_loading'));
